...
public interface ServicioClientes {
    ...
    public void registrarCliente(String cedula, String nombreCompleto, String telefono, String constrasenia);
    ...
    //puse String a medioPago, se puede cambiar si asi se quiere.
    // cambiar de String a una clase abtrascta, con los hijos tarjeta y cuentaUTE.
